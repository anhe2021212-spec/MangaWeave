...
### 1. Sequential readability
- Is reading order clear?
- Does each panel prepare or cause the next?
- Is the page understandable without external explanation?

### 2. Narrative shift
- What changed from first panel to last?
...
- stable, mostly regular paneling
- small event feels sufficient
...
## Page confusing
Action:
- restore establishing shot
- simplify spatial continuity
- reduce simultaneous actions
- give each panel one main job

## Shoujo feels generic
Check:
- what exactly is noticed?
- what remains unsaid?
...
Check:
- would a real person move this way?
- is the friction natural to the location?
- can one reaction panel be quieter?
- can the camera repeat instead of constantly changing?

## Good composition, wrong medium

Treat as failure.

Do not accept a sepia or grayscale illustration merely because the panel layout improved.
